...
var signupUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, existingUser, hashedPassword, user, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                res.json({ message: "User Created", success: true, token: token });
                return [3 /*break*/, 6];
            case 5:
                error_1 = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                res.cookie("jwt", token);
                res.json({ name: user.name, id: user.id, token: token, success: true });
                return [3 /*break*/, 5];
            case 4:
                error_2 = _b.sent();
                return [2 /*return*/, next(http_errors_1.InternalServerError)];
